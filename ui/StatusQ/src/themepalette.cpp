...
{
    customisationColorsArray = QVariantList{
    ...
    communityColorsArray = QVariantList{
        customisationColors.blue,
        customisationColors.yellow,
        customisationColors.magenta,
        customisationColors.purple,
...
std::unique_ptr<ThemePalette> createDarkThemePalette(QObject* parent)
{
    ...
    t->statusMessage.emojiReactionBackground = QColor(0x2d, 0x28, 0x23);
    t->statusMessage.emojiReactionBackgroundHovered = QColor(0x3d, 0x35, 0x2e);
    t->statusMessage.emojiReactionBorderHovered = t->baseColor3;

    // Customisation colors gadget
    ...
    // userCustomizationColors from QML
    t->userCustomizationColors = QVariantList{
    ...
    // privacyModeColors left unset (dark theme QML does not define them explicitly)
    return t;
}
...
std::unique_ptr<ThemePalette> createLightThemePalette(QObject* parent)
{
    ...
    t->statusMessage.emojiReactionBackground = QColor(0xE2, 0xE6, 0xE9);
    t->statusMessage.emojiReactionBackgroundHovered = QColor(0xE7, 0xEA, 0xEE);
    t->statusMessage.emojiReactionBorderHovered = QColor(0xA1, 0xAB, 0xBD);
...
void registerThemePaletteType()
{
    ...
    qmlRegisterUncreatableType<StatusAppLayout>("StatusQ.Theme", 1, 0, "StatusAppLayout", "");
    qmlRegisterUncreatableType<StatusAppNavBar>("StatusQ.Theme", 1, 0, "StatusAppNavBar", "");
    qmlRegisterUncreatableType<StatusToastMessage>("StatusQ.Theme", 1, 0, "StatusToastMessage", "");
    qmlRegisterUncreatableType<StatusListItem>("StatusQ.Theme", 1, 0, "StatusListItem", "");
    qmlRegisterUncreatableType<StatusChatListItem>("StatusQ.Theme", 1, 0, "StatusChatListItem", "");
    qmlRegisterUncreatableType<StatusChatListCategoryItem>("StatusQ.Theme", 1, 0, "StatusChatListCategoryItem", "");
    qmlRegisterUncreatableType<StatusNavigationListItem>("StatusQ.Theme", 1, 0, "StatusNavigationListItem", "");
    qmlRegisterUncreatableType<StatusBadge>("StatusQ.Theme", 1, 0, "StatusBadge", "");
    qmlRegisterUncreatableType<StatusMenu>("StatusQ.Theme", 1, 0, "StatusMenu", "");
    qmlRegisterUncreatableType<StatusModal>("StatusQ.Theme", 1, 0, "StatusModal", "");
    qmlRegisterUncreatableType<StatusRoundedImage>("StatusQ.Theme", 1, 0, "StatusRoundedImage", "");
    qmlRegisterUncreatableType<StatusChatInput>("StatusQ.Theme", 1, 0, "StatusChatInput", "");
    qmlRegisterUncreatableType<StatusSwitchTab>("StatusQ.Theme", 1, 0, "StatusSwitchTab", "");
    qmlRegisterUncreatableType<StatusSelect>("StatusQ.Theme", 1, 0, "StatusSelect", "");
    qmlRegisterUncreatableType<StatusMessage>("StatusQ.Theme", 1, 0, "StatusMessage", "");
    qmlRegisterUncreatableType<CustomisationColors>("StatusQ.Theme", 1, 0, "CustomisationColors", "");
    qmlRegisterUncreatableType<PrivacyModeColors>("StatusQ.Theme", 1, 0, "PrivacyModeColors", "");

    qmlRegisterUncreatableType<ThemePalette>("StatusQ.Theme", 1, 0, "ThemePalette", "");
}
