...
StatusDialog {
    ...
    header: StatusDialogHeader {
        ...
        leftComponent: root.icon !== StatusMessageDialog.StandardIcon.NoIcon ? iconComponent : null // ALT icon placement
    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            Loader {
                ...
                active: root.icon !== StatusMessageDialog.StandardIcon.NoIcon
                visible: active
            }
            StatusBaseText {
                Layout.fillWidth: true
