...
function FilterXSS(options) {
  ...
  if (options.stripIgnoreTag) {
    ...
    options.onIgnoreTag = onIgnoreTagStripAll;
  }

  options.whiteList = options.whiteList || getDefaultWhiteList();
  options.onTag = options.onTag || onTag;
  options.onTagAttr = options.onTagAttr || onTagAttr;
  options.onIgnoreTag = options.onIgnoreTag || onIgnoreTag;
  options.onIgnoreTagAttr = options.onIgnoreTagAttr || onIgnoreTagAttr;
  options.safeAttrValue = options.safeAttrValue || safeAttrValue;
  options.escapeHtml = options.escapeHtml || escapeHtml;
...
FilterXSS.prototype.process = function(html) {
  ...
  if (options.stripIgnoreTagBody) {
    var stripIgnoreTagBody = StripTagBody(
...
function FilterCSS (options) {
  options = shallowCopyObject(options || {});
  options.whiteList = options.whiteList || getDefaultWhiteList()
  options.onAttr = options.onAttr || onAttr;
  options.onIgnoreAttr = options.onIgnoreAttr || onIgnoreAttr;
  options.safeAttrValue = options.safeAttrValue || safeAttrValue;
  this.options = options;
}
