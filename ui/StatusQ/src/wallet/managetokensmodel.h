...
namespace
{
const auto kGroupedTokensKeyRoleName = QByteArrayLiteral("groupedTokensKey");
...
public:
    enum TokenDataRoles {
        GroupedTokensKey = Qt::UserRole + 1,
        TokenKey,
        SymbolRole,
        NameRole,
        CommunityIdRole,
    ...
    std::optional<TokenData> takeItem(const QString& tokenKey);
