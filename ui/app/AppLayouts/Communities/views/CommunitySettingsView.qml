        ...
        Loader {
            ...
            sourceComponent: MintTokensSettingsPanel {
                ...
                onRegisterDeployFeesSubscriber: {
                    ...
                    mintTokensSettingsPanel.subscriptionId = subscription.subscriptionId
                    d.feesBroker.subscribe(subscription)
                }

                onRegisterSelfDestructFeesSubscriber: {
                    const subscription = d.feesBroker.prepareSelfDestructFeesSubscribtion(feeSubscriber)
                    mintTokensSettingsPanel.subscriptionId = subscription.subscriptionId
                    d.feesBroker.subscribe(subscription)
                }
                ...
                onRegisterBurnTokenFeesSubscriber: {
                    ...
                    const subscription = d.feesBroker.prepareBurnFeesSubscribtion(feeSubscriber)
                    mintTokensSettingsPanel.subscriptionId = subscription.subscriptionId
                    d.feesBroker.subscribe(subscription)
                }
        ...
        Loader {
            ...
            sourceComponent: AirdropsSettingsPanel {
                ...
                onRegisterAirdropFeeSubscriber: {
                    const subscription = d.feesBroker.prepareAirdropFeesSubscribtion(feeSubscriber)
                    airdropPanelLoader.subscriptionId = subscription.subscriptionId
                    d.feesBroker.subscribe(subscription)
                }
