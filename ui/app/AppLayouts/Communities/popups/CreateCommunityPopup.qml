    ...
    stackItems: [
        StatusScrollView {
            ...
            readonly property var nextAction: () => {
                generalViewLayout.validate(root.isDevBuild)
                if (generalViewLayout.isNameValid && generalViewLayout.isDescriptionValid &&
                    (root.isDevBuild || (generalViewLayout.isLogoSelected && generalViewLayout.isBannerSelected && generalViewLayout.areTagsSelected))) {
                    root.currentIndex++
                }
            }
