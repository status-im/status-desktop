...
QtObject {
    ...
    readonly property var keycardSharedModuleForAuthenticationOrSigning: internal.mainModuleInst.keycardSharedModuleForAuthenticationOrSigning
    readonly property var keycardSharedModule: internal.mainModuleInst.keycardSharedModule
