...
Item {
    ...
    AssetsDetailsHeader {
        ...
        formatBalance: function(balance){
            return LocaleUtils.currencyAmountToLocaleString(root.currencyStore.getCurrencyAmount(balance, tokenGroup.symbol))
        }
                    ...
                    InformationTileAssetDetails {
                        ...
                        content: InformationTag {
                            ...
                            StatusMouseArea {
                                ...
                                onClicked: Global.openLink(tokenGroup.websiteUrl)
                            }
                        }
                    }
