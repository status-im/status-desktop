...
Rectangle {
    ...
    QtObject {
        ...
        function recalculateCustomBaseFeePrice() {
            ...
            const weiValue = SQUtils.Utils.gweiToWei(customBaseFeeInput.text).toFixed()
        ...
        function recalculateCustomPriorityFeePrice() {
            ...
            const weiValue = SQUtils.Utils.gweiToWei(customPriorityFeeInput.text).toFixed()
        ...
        function recalculateCustomPrice() {
            ...
            const baseFeeWei = SQUtils.Utils.gweiToWei(customBaseFeeInput.text)
            const priorityFeeWei = SQUtils.Utils.gweiToWei(customPriorityFeeInput.text)
            ...
            ShapeRectangle {
                ...
                ColumnLayout {
                    ...
                    StatusInput {
                        ...
                        bottomLabelMessageLeftCmp.color: Theme.palette.baseColor1
                        bottomLabelMessageLeftCmp.text: qsTr("Current: %1 GWEI").arg(SQUtils.Utils.weiToGWei(root.currentBaseFee))
                    ...
                    StatusInput {
                        ...
                        labelIconClickable: true
                        bottomLabelMessageLeftCmp.color: Theme.palette.baseColor1
                        bottomLabelMessageLeftCmp.text: qsTr("Current: %1 - %2 GWEI").arg(SQUtils.Utils.weiToGWei(root.currentSuggestedMinPriorityFee)).arg(SQUtils.Utils.weiToGWei(root.currentSuggestedMaxPriorityFee))
                        rightPadding: leftPadding
                        input.rightComponent: StatusBaseText {
                            text: "GWEI"
                            color: Theme.palette.baseColor1
                    ...
                    StatusInput {
                        ...
                        labelIconClickable: true
                        bottomLabelMessageLeftCmp.color: Theme.palette.baseColor1
                        bottomLabelMessageLeftCmp.text: qsTr("Current: %1").arg(root.currentGasAmount)
                        rightPadding: leftPadding
                        input.rightComponent: StatusBaseText {
                            text: "UNITS"
                            color: Theme.palette.baseColor1
                    ...
                    StatusInput {
                        ...
                        rightPadding: leftPadding
                        input.rightComponent: undefined
