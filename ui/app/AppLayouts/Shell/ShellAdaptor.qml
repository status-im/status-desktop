    ...
    **/
    ...
    ObjectProxyModel {
        ...
        delegate: QtObject {
            ...
            readonly property string sectionName: model.sectionName
            readonly property int chatType: model.chatType // cf. Constants.chatType.*
        }

        expectedRoles: ["sectionId", "chatId", "chatType", "name", "sectionName", "emoji", "icon", "color", "colorId"]
        exposedRoles: ["key", "id", "chatType", "sectionName", "name", "icon", "color"]
    }
