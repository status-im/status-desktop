...
QObject {
    ...
    ObjectProxyModel {
        ...
        expectedRoles: ["id", "name", "icon", "color", "bannerImageData", "hasNotification", "notificationsCount", "allMembers", "activeMembersCount"]
        exposedRoles: ["key", "id", "name", "icon", "color", "banner", "hasNotification", "notificationsCount", "members", "activeMembers"]
    }
    ...
    ConcatModel {
        ...
        expectedRoles: ["key", "id", "name", "icon", "color", "hasNotification", "notificationsCount", // common props
            "banner", "members", "activeMembers", // community
    ...
    SortFilterProxyModel {
        ...
        sorters: [
            RoleSorter {
                roleName: "hasNotification"
                sortOrder: Qt.DescendingOrder // true > false
            },
            RoleSorter {
                roleName: "notificationsCount"
                sortOrder: Qt.DescendingOrder // 1 > 0
            },
            RoleSorter {
                roleName: "name"
            }
