...
ShellGridItem {
    ...
    iconLoaderComponent: StatusSmartIdenticon {
        asset.bgBorderWidth: 2
        asset.bgBorderColor: hovered ? "#222833" : "#161c27"

        asset.emoji: root.chatType !== StatusChatListItem.Type.OneToOneChat ? root.icon.name : ""
        asset.color: root.icon.color
        asset.name: root.chatType === StatusChatListItem.Type.OneToOneChat ? root.icon.name : ""
