...
Control {
    ...
    // Max content height before eliding text.
    property int    contentMaxHeigth: 72
    ...
    contentItem: ColumnLayout {
        ...
        StatusBaseText {
            ...
            readonly property int plainTextLength : Utils.plainTextLength(root.contentText)

            Layout.fillWidth: true
            Layout.maximumHeight: root.contentMaxHeigth
