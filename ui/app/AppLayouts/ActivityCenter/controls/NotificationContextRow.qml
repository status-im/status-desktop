...
// NOTES
// -----
// * Optional maximum character counts for both texts (design fallback).
// -----------------------------------------------------------------------------
...
Control {
    ...
    property int    separatiorSize: Theme.fontSize16

    // Maximum number of characters for primary text before truncation
    property int    maxPrimaryTextChars: 24

    // Maximum number of characters for secondary text before truncation
    property int    maxSecondaryTextChars: 18
    ...
    contentItem:Flow {
        ...
        // Primary text
        StatusBaseText {
            text: root.primaryText.length > root.maxPrimaryTextChars ? Utils.elideText(root.primaryText, root.maxPrimaryTextChars, 0) :
                                                                       root.primaryText
        ...
        StatusBaseText {
            ...
            text: root.secondaryText.length > root.maxSecondaryTextChars ? Utils.elideText(root.secondaryText, root.maxSecondaryTextChars, 0) :
                                                                           root.secondaryText
