...
SettingsContentBase {
    ...
    signal fontSizeChanged(value: int)

    property int currentZoom: 2
    signal zoomChanged(value: int)

    property int currentTheme: 0
    signal themeChanged(value: string)
    ...
    Item {
        ...
        Rectangle {
            ...
            // TODO: removed for now due to massive dependencies it currently brings, should be done as a new component just for preview purposes
            // MessageView {
        ...
        StatusQ.StatusLabeledSlider {
            ...
            onCurrentValueChanged: { fontSizeChanged(currentValue) }
        }
        ...
        RowLayout {
            ...
            StatusImageRadioButton {
                ...
                control.checked: appearanceView.currentTheme === 0
                onRadioCheckedChanged: appearanceView.themeChanged(0)
            }
            ...
            StatusImageRadioButton {
                ...
                control.checked: appearanceView.currentTheme === 1
                onRadioCheckedChanged: appearanceView.themeChanged(1)
            }
            ...
            StatusImageRadioButton {
                ...
                control.checked: appearanceView.currentTheme === 2
                onRadioCheckedChanged: appearanceView.themeChanged(2)
            }
        }
    }
}
