...
import "./CollectibleViewComponents"
...
Item {
    ...
    function open(options) {
        ...
        rightPanelRoot.switchTo(rightPanelRoot.rightPanelViewCollectiblesItemView)
    }

    function hide() {
        rightPanelRoot.switchTo(rightPanelRoot.rightPanelViewMain,
                                rightPanelRoot.rightPanelViewMainTabCollectibles)
