...
StatusSectionLayout {
    ...
    QtObject {
        ...
        readonly property var script: ({
            ...
            sourceUrl: Qt.resolvedUrl("./helpers/provider.js"), // FIXME needs to be revisited
        ...
        property QtObject defaultProfile: WebEngineProfile {
            ...
            // FIXME script disabled as it crashes the browser
    ...
    centerPanel: Rectangle {
        ...
        Rectangle {
            ...
            anchors.left: parent.left
            anchors.bottom: parent.bottom
            width: statusText.paintedWidth + Theme.halfPadding
            height: statusText.paintedHeight + Theme.halfPadding
