...
Popup {
    ...
    Component {
        ...
        ColumnLayout {
            ...
            // Or enable RSS notification panel, or, it's just enable status news notifications panel
            property bool isEnableRSSNotificationPanelType: !d.isStatusNewsViaRSSEnabled
