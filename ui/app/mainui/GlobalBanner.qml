...
Loader {
    ...
    QtObject {
        ...
        property bool showConnectedBanner // NB: not really a binding
    }

    Component.onCompleted: d.showConnectedBanner = !root.isOnline // initially, we don't want to show the "You are online" banner
