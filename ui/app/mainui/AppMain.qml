    ...
    StatusMainLayout {
        ...
        rightPanel: ColumnLayout {
            ...
            ColumnLayout {
                ...
                enabled: !localAppSettings.testEnvironment && d.activeSectionType !== Constants.appSection.homePage
                visible: enabled
                ...
                GlobalBanner {
                    ...
                    isOnline: appMain.rootStore.mainModuleInst.isOnline
                    ...
                    onUserDeclinedBackupBannerRequested: appMain.profileStore.userDeclinedBackupBanner = true
                }
            ...
            Item {
                ...
                StackLayout {
                    ...
                    onCurrentIndexChanged: {
                        if (d.sectionType !== Constants.appSection.profile && d.sectionType !== Constants.appSection.wallet) {
