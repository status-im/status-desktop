...
StatusWindow {
    ...
    */
    ...
    Component.onCompleted: {
        ...
        console.warn("!!! CURRENT LANGUAGE:", languageStore.currentLanguage)
        console.warn("!!! LANGUAGES:", languageStore.availableLanguages) // <-- what we have

        console.warn("!!! Qt UI LANGUAGE:", Qt.uiLanguage) // <-- what the user wants ideally
