...
StatusStackModal {
    ...
    finishButton: StatusButton {
        enabled: {
            if (root.isInvitationPending || root.accessType !== Constants.communityChatOnRequestAccess)
                return true
    ...
    QtObject {
        ...
        readonly property int eligibleToJoinAs: {
            d.selectedSharedAddressesMap // needed for binding
            return PermissionsHelpers.isEligibleToJoinAs(root.permissionsModel)
        }
        ...
        StatusScrollView {
            ...
            ColumnLayout {
                ...
                CommunityEligibilityTag {
                    Layout.alignment: Qt.AlignHCenter
                    eligibleToJoinAs: d.eligibleToJoinAs
                    visible: !root.isEditMode && !root.isInvitationPending && root.accessType === Constants.communityChatOnRequestAccess &&
                             eligibleToJoinAs != -1
                }
            }
        }
