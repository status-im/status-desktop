...
public:
    ...
    static WalletController *create(QQmlEngine *qmlEngine, QJSEngine *jsEngine);
    ...
    Q_INVOKABLE Status::Wallet::NewWalletAccountController* createNewWalletAccountController() const;
