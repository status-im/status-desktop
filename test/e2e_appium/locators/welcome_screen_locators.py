...
class WelcomeScreenLocators(BaseLocators):
    ...
    WELCOME_PAGE = (AppiumBy.ACCESSIBILITY_ID, "Welcome to Status")
    
    # Primary buttons - using stable content-desc (QMLTYPE numbers are dynamic)
    CREATE_PROFILE_BUTTON = (AppiumBy.ACCESSIBILITY_ID, "Create profile")
    LOGIN_BUTTON = (AppiumBy.ACCESSIBILITY_ID, "Log in")
    
    # Container locators - stable without QMLTYPE
    ONBOARDING_LAYOUT = (AppiumBy.ID, "QGuiApplication.mainWindow.startupOnboardingLayout") 