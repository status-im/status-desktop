...
class LoadingScreenLocators(BaseLocators):
    ...
    SPLASH_SCREEN = (AppiumBy.ID, "QGuiApplication.mainWindow.startupOnboardingLayout.OnboardingFlow_QMLTYPE_206.splashScreenV2")
    
    # Alternative using partial ID (avoiding dynamic QMLTYPE)
    SPLASH_SCREEN_PARTIAL = (AppiumBy.XPATH, "//*[contains(@resource-id, 'splashScreenV2')]")
