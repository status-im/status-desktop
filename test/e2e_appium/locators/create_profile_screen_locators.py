...
class CreateProfileScreenLocators(BaseLocators):
    ...
    LETS_GO_BUTTON_BY_ID = (AppiumBy.XPATH, "//*[contains(@resource-id, 'btnCreateWithPassword')]")
    CREATE_PROFILE_PARTIAL = (AppiumBy.XPATH, "//*[contains(@resource-id, 'CreateProfilePage')]") 