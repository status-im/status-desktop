...
class MainAppLocators(BaseLocators):
    ...
    # Shell container - stable partial resource-id
    SHELL_CONTAINER = (AppiumBy.ID, "QGuiApplication.mainWindow.StatusMainLayout_QMLTYPE_1412.Control_QMLTYPE_234.shellContainer")
    SHELL_CONTAINER_PARTIAL = (AppiumBy.XPATH, "//*[contains(@resource-id, 'shellContainer')]")
    ...
    SEARCH_FIELD = (AppiumBy.ACCESSIBILITY_ID, "Jump to a community, chat, account or a dApp...")
