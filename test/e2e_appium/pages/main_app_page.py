...
from locators.main_app_locators import MainAppLocators
...
class MainAppPage(BasePage):
    ...
    def is_main_app_loaded(self) -> bool:
        ...
        return self.is_element_visible(self.locators.SHELL_CONTAINER_PARTIAL)
    
    def is_shell_container_visible(self) -> bool:
        """Check if the shell container is visible"""
        return self.is_element_visible(self.locators.SHELL_CONTAINER_PARTIAL)
    ...
    def click_wallet_button(self) -> bool:
        """Click the Wallet button in the dock"""
    ...
    def click_messages_button(self) -> bool:
        """Click the Messages button in the dock"""
    ...
    def click_communities_button(self) -> bool:
        """Click the Communities Portal button in the dock"""
    ...
    def click_settings_button(self) -> bool:
        """Click the Settings button in the dock"""
