...
class UserFactory:
    ...
    def with_primary_address(self, address: str, network: str = "ethereum") -> 'UserFactory':
    ...
    def with_additional_address(self, address: str, network: str, name: str = None) -> 'UserFactory':
