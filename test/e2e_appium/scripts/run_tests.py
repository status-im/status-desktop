...
def validate_environment():
    ...
    try:
        ...
        print(f"Device: {config.device_name} ({config.platform_name} {config.platform_version})")
...
def main():
    ...
    parser.add_argument('--reports-dir',
                       help='Custom reports directory (overrides config)')
