...
backup_seed_phrase_popup_step_StyledText = {"container": statusDesktop_mainWindow_overlay, "text": RegularExpression("Step*"), "type": "StyledText", "unnamed": 1, "visible": True}
