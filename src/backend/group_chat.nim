...
proc createOneToOneChat*(
    communityID: string, id: string, ensName: string
...
proc createGroupChat*(
    communityID: string, name: string, members: seq[string]
): RpcResponse[JsonNode] =
...
proc createGroupChatFromInvitation*(
    name: string, chatID: string, adminPK: string
): RpcResponse[JsonNode] =
...
proc leaveChat*(
    communityID: string, chatID: string, remove: bool
): RpcResponse[JsonNode] =
...
proc addMembers*(
    communityID: string, chatID: string, members: seq[string]
): RpcResponse[JsonNode] =
...
proc removeMember*(
    communityID: string, chatID: string, member: string
): RpcResponse[JsonNode] =
...
proc renameChat*(
    communityID: string, chatID: string, name: string
): RpcResponse[JsonNode] =
  let payload = %*[communityID, chatID, name]

  return core.callPrivateRPC("chat_renameChat", payload)

proc sendGroupChatInvitationRequest*(
    communityID: string, chatID: string, adminPK: string, message: string
): RpcResponse[JsonNode] =
...
proc sendGroupChatInvitationRejection*(
