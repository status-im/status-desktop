...
proc createTokenListItem*(tlDto: TokenListDto): TokenListItem =
  return TokenListItem(
    id: tlDto.id,
    name: tlDto.name,
    timestamp: common_utils.timestampToUnix(tlDto.timestamp, DATE_TIME_FORMAT_1),
    fetchedTimestamp: common_utils.timestampToUnix(tlDto.fetchedTimestamp, DATE_TIME_FORMAT_1),
    source: tlDto.source,
    version: VersionItem(
