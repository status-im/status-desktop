...
const BASE_NAME_STATUS_PROXY_MARKET_USER = "STATUS_PROXY_MARKET_USER"
const BASE_NAME_STATUS_PROXY_MARKET_PASSWORD = "STATUS_PROXY_MARKET_PASSWORD"
...
const BUILD_STATUS_PROXY_MARKET_USER = getEnv(BUILD_TIME_PREFIX & BASE_NAME_STATUS_PROXY_MARKET_USER)
const BUILD_STATUS_PROXY_MARKET_PASSWORD = getEnv(BUILD_TIME_PREFIX & BASE_NAME_STATUS_PROXY_MARKET_PASSWORD)
...
type StatusDesktopConfig = object
  ...
  statusProxyMarketUser* {.
    ...
    desc: "Sets status proxy market username"
  ...
  statusProxyMarketPassword* {.
    ...
    desc: "Sets status proxy market password"
