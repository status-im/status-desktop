...
type ToggleSectionArgs* = ref object of Args
...
type ActiveSectionChatArgs* = ref object of Args
  sectionId*: string
  chatId*: string
  messageId*: string
...
type StatusUrlAction* {.pure.} = enum
  OpenLinkInBrowser = 0
  DisplayUserProfile
  OpenCommunity
  OpenCommunityChannel

type StatusUrlArgs* = ref object of Args
...
type WalletAddressesArgs* = ref object of Args
