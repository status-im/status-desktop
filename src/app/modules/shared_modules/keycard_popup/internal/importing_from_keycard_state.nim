type ImportingFromKeycardState* = ref object of State
  paths: seq[string]
  addresses: seq[string]

proc newImportingFromKeycardState*(
    flowType: FlowType, backState: State
): ImportingFromKeycardState =
...
proc addAccountsToWallet(
    self: ImportingFromKeycardState, controller: Controller
): bool =
