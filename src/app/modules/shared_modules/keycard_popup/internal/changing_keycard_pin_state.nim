type ChangingKeycardPinState* = ref object of State

proc newChangingKeycardPinState*(
    flowType: FlowType, backState: State
): ChangingKeycardPinState =
