type CopyingKeycardFailureState* = ref object of State

proc newCopyingKeycardFailureState*(
    flowType: FlowType, backState: State
): CopyingKeycardFailureState =
...
method executePrePrimaryStateCommand*(
    self: CopyingKeycardFailureState, controller: Controller
) =
