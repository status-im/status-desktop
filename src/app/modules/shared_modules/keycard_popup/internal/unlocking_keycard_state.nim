type UnlockingKeycardState* = ref object of State

proc newUnlockingKeycardState*(
    flowType: FlowType, backState: State
): UnlockingKeycardState =
...
method executePrePrimaryStateCommand*(
    self: UnlockingKeycardState, controller: Controller
) =
