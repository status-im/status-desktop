type MaxPukRetriesReachedState* = ref object of State

proc newMaxPukRetriesReachedState*(
    flowType: FlowType, backState: State
): MaxPukRetriesReachedState =
...
method executePrePrimaryStateCommand*(
    self: MaxPukRetriesReachedState, controller: Controller
) =
