type ImportingFromKeycardFailureState* = ref object of State

proc newImportingFromKeycardFailureState*(
    flowType: FlowType, backState: State
): ImportingFromKeycardFailureState =
...
method executePrePrimaryStateCommand*(
    self: ImportingFromKeycardFailureState, controller: Controller
) =
