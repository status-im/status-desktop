type ChangingKeycardPairingCodeFailureState* = ref object of State

proc newChangingKeycardPairingCodeFailureState*(
    flowType: FlowType, backState: State
): ChangingKeycardPairingCodeFailureState =
...
method executePrePrimaryStateCommand*(
    self: ChangingKeycardPairingCodeFailureState, controller: Controller
) =
