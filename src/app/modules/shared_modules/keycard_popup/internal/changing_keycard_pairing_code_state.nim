type ChangingKeycardPairingCodeState* = ref object of State

proc newChangingKeycardPairingCodeState*(
    flowType: FlowType, backState: State
): ChangingKeycardPairingCodeState =
...
method executePreSecondaryStateCommand*(
    self: ChangingKeycardPairingCodeState, controller: Controller
) =
...
method resolveKeycardNextState*(
    self: ChangingKeycardPairingCodeState,
