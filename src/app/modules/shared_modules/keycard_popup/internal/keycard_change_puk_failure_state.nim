type ChangingKeycardPukFailureState* = ref object of State

proc newChangingKeycardPukFailureState*(
...
method executePrePrimaryStateCommand*(
    self: ChangingKeycardPukFailureState, controller: Controller
) =
