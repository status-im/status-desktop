type KeycardEmptyMetadataState* = ref object of State

proc newKeycardEmptyMetadataState*(
    flowType: FlowType, backState: State
): KeycardEmptyMetadataState =
...
method executePrePrimaryStateCommand*(
    self: KeycardEmptyMetadataState, controller: Controller
) =
...
method resolveKeycardNextState*(
    self: KeycardEmptyMetadataState,
