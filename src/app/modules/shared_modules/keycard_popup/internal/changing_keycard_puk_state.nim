type ChangingKeycardPukState* = ref object of State

proc newChangingKeycardPukState*(
    flowType: FlowType, backState: State
): ChangingKeycardPukState =
