type CreatingAccountNewSeedPhraseSuccessState* = ref object of State

proc newCreatingAccountNewSeedPhraseSuccessState*(
    flowType: FlowType, backState: State
): CreatingAccountNewSeedPhraseSuccessState =
...
method executePrePrimaryStateCommand*(
    self: CreatingAccountNewSeedPhraseSuccessState, controller: Controller
) =
