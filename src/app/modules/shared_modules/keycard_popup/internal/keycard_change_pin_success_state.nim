type ChangingKeycardPinSuccessState* = ref object of State

proc newChangingKeycardPinSuccessState*(
    flowType: FlowType, backState: State
): ChangingKeycardPinSuccessState =
...
method executePrePrimaryStateCommand*(
    self: ChangingKeycardPinSuccessState, controller: Controller
) =
