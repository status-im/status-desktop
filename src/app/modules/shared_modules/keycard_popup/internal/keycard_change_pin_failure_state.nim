type ChangingKeycardPinFailureState* = ref object of State

proc newChangingKeycardPinFailureState*(
    flowType: FlowType, backState: State
): ChangingKeycardPinFailureState =
...
method executePrePrimaryStateCommand*(
    self: ChangingKeycardPinFailureState, controller: Controller
) =
