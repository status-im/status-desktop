type MigrateKeypairToKeycardState* = ref object of State

proc newMigrateKeypairToKeycardState*(
    flowType: FlowType, backState: State
): MigrateKeypairToKeycardState =
...
method executeCancelCommand*(
    self: MigrateKeypairToKeycardState, controller: Controller
) =
...
method resolveKeycardNextState*(
    self: MigrateKeypairToKeycardState,
