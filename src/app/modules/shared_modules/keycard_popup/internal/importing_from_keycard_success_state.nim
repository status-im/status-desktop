type ImportingFromKeycardSuccessState* = ref object of State

proc newImportingFromKeycardSuccessState*(
    flowType: FlowType, backState: State
): ImportingFromKeycardSuccessState =
...
method executePrePrimaryStateCommand*(
    self: ImportingFromKeycardSuccessState, controller: Controller
) =
