type CreatingAccountOldSeedPhraseFailureState* = ref object of State

proc newCreatingAccountOldSeedPhraseFailureState*(
    flowType: FlowType, backState: State
): CreatingAccountOldSeedPhraseFailureState =
...
method executePrePrimaryStateCommand*(
    self: CreatingAccountOldSeedPhraseFailureState, controller: Controller
) =
