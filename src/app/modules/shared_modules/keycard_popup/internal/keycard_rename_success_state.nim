type KeycardRenameSuccessState* = ref object of State

proc newKeycardRenameSuccessState*(
    flowType: FlowType, backState: State
): KeycardRenameSuccessState =
...
method executePrePrimaryStateCommand*(
    self: KeycardRenameSuccessState, controller: Controller
) =
