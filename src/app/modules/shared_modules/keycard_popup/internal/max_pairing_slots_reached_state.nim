type MaxPairingSlotsReachedState* = ref object of State

proc newMaxPairingSlotsReachedState*(
    flowType: FlowType, backState: State
): MaxPairingSlotsReachedState =
...
method executePrePrimaryStateCommand*(
    self: MaxPairingSlotsReachedState, controller: Controller
) =
