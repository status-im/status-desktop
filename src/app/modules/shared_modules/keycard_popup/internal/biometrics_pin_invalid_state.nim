type BiometricsPinInvalidState* = ref object of State

proc newBiometricsPinInvalidState*(
    flowType: FlowType, backState: State
): BiometricsPinInvalidState =
...
method executePrePrimaryStateCommand*(
    self: BiometricsPinInvalidState, controller: Controller
) =
...
method resolveKeycardNextState*(
    self: BiometricsPinInvalidState,
