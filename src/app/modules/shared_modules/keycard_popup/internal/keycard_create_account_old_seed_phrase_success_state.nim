type CreatingAccountOldSeedPhraseSuccessState* = ref object of State

proc newCreatingAccountOldSeedPhraseSuccessState*(
...
method executePrePrimaryStateCommand*(
    self: CreatingAccountOldSeedPhraseSuccessState, controller: Controller
) =
