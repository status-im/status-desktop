type KeycardRenameFailureState* = ref object of State

proc newKeycardRenameFailureState*(
    flowType: FlowType, backState: State
): KeycardRenameFailureState =
...
method executePrePrimaryStateCommand*(
    self: KeycardRenameFailureState, controller: Controller
) =
