type WrongKeychainPinState* = ref object of State

proc newWrongKeychainPinState*(
    flowType: FlowType, backState: State
): WrongKeychainPinState =
...
method getNextPrimaryState*(
    self: WrongKeychainPinState, controller: Controller
): State =
