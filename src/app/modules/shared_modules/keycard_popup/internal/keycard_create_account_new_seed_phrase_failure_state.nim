type CreatingAccountNewSeedPhraseFailureState* = ref object of State

proc newCreatingAccountNewSeedPhraseFailureState*(
    flowType: FlowType, backState: State
): CreatingAccountNewSeedPhraseFailureState =
...
method executePrePrimaryStateCommand*(
    self: CreatingAccountNewSeedPhraseFailureState, controller: Controller
) =
