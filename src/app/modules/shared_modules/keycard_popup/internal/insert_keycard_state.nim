type InsertKeycardState* = ref object of State
...
method executePreBackStateCommand*(self: InsertKeycardState, controller: Controller) =
  if self.flowType == FlowType.SetupNewKeycard:
    if not self.getBackState.isNil and
        self.getBackState.stateType == StateType.SelectExistingKeyPair:
