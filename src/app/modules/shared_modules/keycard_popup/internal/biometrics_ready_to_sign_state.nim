type BiometricsReadyToSignState* = ref object of State

proc newBiometricsReadyToSignState*(
    flowType: FlowType, backState: State
): BiometricsReadyToSignState =
...
method executePrePrimaryStateCommand*(
    self: BiometricsReadyToSignState, controller: Controller
) =
