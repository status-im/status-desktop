type SeedPhraseAlreadyInUseState* = ref object of State
  verifiedSeedPhrase: bool

proc newSeedPhraseAlreadyInUseState*(
    flowType: FlowType, backState: State
): SeedPhraseAlreadyInUseState =
...
method executePrePrimaryStateCommand*(
    self: SeedPhraseAlreadyInUseState, controller: Controller
) =
