type ConfirmAddingNewMasterKeyState* = ref object of State

proc newConfirmAddingNewMasterKeyState*(
    backState: State
): ConfirmAddingNewMasterKeyState =
...
method executePrePrimaryStateCommand*(
    self: ConfirmAddingNewMasterKeyState, controller: Controller
) =
