...
method discordImportProgressUpdated*(self: AccessInterface, communityId: string, tasks: seq[DiscordImportTaskProgress], progress: float, errorsCount: int, warningsCount: int, stopped: bool) {.base.} =
  raise newException(ValueError, "No implementation available")
