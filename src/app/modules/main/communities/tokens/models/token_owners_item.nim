...
proc remoteDestructTransactionStatus*(
    remoteDestructedAddresses: seq[string], address: string
...
proc initTokenOwnersItem*(
  ...
  result.remotelyDestructState =
    remoteDestructTransactionStatus(remoteDestructedAddresses, ownerDetails.address)
