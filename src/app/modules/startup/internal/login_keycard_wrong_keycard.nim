type LoginKeycardWrongKeycardState* = ref object of State

proc newLoginKeycardWrongKeycardState*(
    flowType: FlowType, backState: State
): LoginKeycardWrongKeycardState =
...
method executePrimaryCommand*(
    self: LoginKeycardWrongKeycardState, controller: Controller
) =
...
method resolveKeycardNextState*(
    self: LoginKeycardWrongKeycardState,
