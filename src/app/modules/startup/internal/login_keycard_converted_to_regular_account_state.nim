type LoginKeycardConvertedToRegularAccountState* = ref object of State

proc newLoginKeycardConvertedToRegularAccountState*(
    flowType: FlowType, backState: State
): LoginKeycardConvertedToRegularAccountState =
...
method executePrimaryCommand*(
    self: LoginKeycardConvertedToRegularAccountState, controller: Controller
) =
