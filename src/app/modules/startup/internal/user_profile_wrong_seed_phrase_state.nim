type UserProfileWrongSeedPhraseState* = ref object of State

proc newUserProfileWrongSeedPhraseState*(
    flowType: FlowType, backState: State
): UserProfileWrongSeedPhraseState =
...
method executeBackCommand*(
    self: UserProfileWrongSeedPhraseState, controller: Controller
) =
