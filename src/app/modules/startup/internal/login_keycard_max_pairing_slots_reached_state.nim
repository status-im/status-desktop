type LoginKeycardMaxPairingSlotsReachedState* = ref object of State

proc newLoginKeycardMaxPairingSlotsReachedState*(
    flowType: FlowType, backState: State
): LoginKeycardMaxPairingSlotsReachedState =
...
method executeBackCommand*(
    self: LoginKeycardMaxPairingSlotsReachedState, controller: Controller
) =
...
method resolveKeycardNextState*(
    self: LoginKeycardMaxPairingSlotsReachedState,
