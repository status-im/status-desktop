type LoginKeycardInsertedKeycardState* = ref object of State

proc newLoginKeycardInsertedKeycardState*(
    flowType: FlowType, backState: State
): LoginKeycardInsertedKeycardState =
...
method getNextPrimaryState*(
    self: LoginKeycardInsertedKeycardState, controller: Controller
): State =
