type ProfileFetchingTimeoutState* = ref object of State

proc newProfileFetchingTimeoutState*(
    flowType: FlowType, backState: State
): ProfileFetchingTimeoutState =
...
method executePrimaryCommand*(
    self: ProfileFetchingTimeoutState, controller: Controller
) =
