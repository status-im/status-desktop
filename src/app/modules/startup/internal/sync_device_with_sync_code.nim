type SyncDeviceWithSyncCodeState* = ref object of State

proc newSyncDeviceWithSyncCodeState*(
    flowType: FlowType, backState: State
): SyncDeviceWithSyncCodeState =
...
method executePrimaryCommand*(
    self: SyncDeviceWithSyncCodeState, controller: Controller
) =
