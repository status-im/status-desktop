type KeycardRecognizedKeycardState* = ref object of State

proc newKeycardRecognizedKeycardState*(
    flowType: FlowType, backState: State
): KeycardRecognizedKeycardState =
...
method executeBackCommand*(
    self: KeycardRecognizedKeycardState, controller: Controller
) =
