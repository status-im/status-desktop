type KeycardMaxPairingSlotsReachedState* = ref object of State

proc newKeycardMaxPairingSlotsReachedState*(
    flowType: FlowType, backState: State
): KeycardMaxPairingSlotsReachedState =
...
method getNextPrimaryState*(
    self: KeycardMaxPairingSlotsReachedState, controller: Controller
): State =
