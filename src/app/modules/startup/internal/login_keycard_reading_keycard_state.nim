...
type LoginKeycardReadingKeycardState* = ref object of State

proc newLoginKeycardReadingKeycardState*(
    flowType: FlowType, backState: State
): LoginKeycardReadingKeycardState =
...
method getNextPrimaryState*(
    self: LoginKeycardReadingKeycardState, controller: Controller
): State =
...
method resolveKeycardNextState*(
    self: LoginKeycardReadingKeycardState,
