type LoginKeycardEnterPasswordState* = ref object of State

proc newLoginKeycardEnterPasswordState*(
    flowType: FlowType, backState: State
): LoginKeycardEnterPasswordState =
...
method executePrimaryCommand*(
    self: LoginKeycardEnterPasswordState, controller: Controller
) =
