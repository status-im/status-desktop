type LoginKeycardInsertKeycardState* = ref object of State

proc newLoginKeycardInsertKeycardState*(
    flowType: FlowType, backState: State
): LoginKeycardInsertKeycardState =
...
method getNextTertiaryState*(
    self: LoginKeycardInsertKeycardState, controller: Controller
): State =
...
method resolveKeycardNextState*(
  ...
  let state = ensureReaderAndCardPresenceAndResolveNextLoginState(
