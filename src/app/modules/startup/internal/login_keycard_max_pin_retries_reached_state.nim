type LoginKeycardMaxPinRetriesReachedState* = ref object of State

proc newLoginKeycardMaxPinRetriesReachedState*(
    flowType: FlowType, backState: State
): LoginKeycardMaxPinRetriesReachedState =
...
method executeBackCommand*(
    self: LoginKeycardMaxPinRetriesReachedState, controller: Controller
) =
...
method resolveKeycardNextState*(
    self: LoginKeycardMaxPinRetriesReachedState,
