type LoginKeycardRecognizedKeycardState* = ref object of State

proc newLoginKeycardRecognizedKeycardState*(
    flowType: FlowType, backState: State
): LoginKeycardRecognizedKeycardState =
...
method getNextPrimaryState*(
    self: LoginKeycardRecognizedKeycardState, controller: Controller
): State =
