type LoginKeycardWrongPinState* = ref object of State
  pinValid: bool

proc newLoginKeycardWrongPinState*(
    flowType: FlowType, backState: State
): LoginKeycardWrongPinState =
...
method getNextTertiaryState*(
    self: LoginKeycardWrongPinState, controller: Controller
): State =
  if self.flowType == FlowType.AppLogin:
