type LoginKeycardEmptyState* = ref object of State

proc newLoginKeycardEmptyState*(
    flowType: FlowType, backState: State
): LoginKeycardEmptyState =
...
method getNextSecondaryState*(
    self: LoginKeycardEmptyState, controller: Controller
): State =
