type KeycardMaxPinRetriesReachedState* = ref object of State

proc newKeycardMaxPinRetriesReachedState*(
    flowType: FlowType, backState: State
): KeycardMaxPinRetriesReachedState =
...
method getNextPrimaryState*(
    self: KeycardMaxPinRetriesReachedState, controller: Controller
): State =
