type KeycardDisplaySeedPhraseState* = ref object of State

proc newKeycardDisplaySeedPhraseState*(
    flowType: FlowType, backState: State
): KeycardDisplaySeedPhraseState =
...
method executeBackCommand*(
    self: KeycardDisplaySeedPhraseState, controller: Controller
) =
  controller.setPin("")
...
method getNextPrimaryState*(
  ...
  return
    createState(StateType.KeycardEnterSeedPhraseWords, self.flowType, self.getBackState)
