type LoginNotKeycardState* = ref object of State

proc newLoginNotKeycardState*(
    flowType: FlowType, backState: State
): LoginNotKeycardState =
...
method getNextTertiaryState*(
    self: LoginNotKeycardState, controller: Controller
): State =
  if self.flowType == FlowType.AppLogin:
