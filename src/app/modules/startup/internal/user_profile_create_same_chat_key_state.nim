type UserProfileCreateSameChatKeyState* = ref object of State

proc newUserProfileCreateSameChatKeyState*(
    flowType: FlowType, backState: State
): UserProfileCreateSameChatKeyState =
...
method getNextPrimaryState*(
    self: UserProfileCreateSameChatKeyState, controller: Controller
): State =
