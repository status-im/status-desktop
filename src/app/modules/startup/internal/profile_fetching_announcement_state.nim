type ProfileFetchingAnnouncementState* = ref object of State

proc newProfileFetchingAnnouncementState*(
    flowType: FlowType, backState: State
): ProfileFetchingAnnouncementState =
...
method executePrimaryCommand*(
    self: ProfileFetchingAnnouncementState, controller: Controller
) =
