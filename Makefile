...
$(STATUS_CLIENT_APPIMAGE): nim_status_client $(APPIMAGE_TOOL) nim-status.desktop
	...
	cp vendor/status-lib/vendor/nim-keycard-go/go/keycard/build/libkeycard/libkeycard.so tmp/linux/dist/usr/lib/
	cp vendor/status-lib/vendor/nim-keycard-go/go/keycard/build/libkeycard/libkeycard.so.0 tmp/linux/dist/usr/lib/
