...
QJsonObject Service::prepareAccountSettingsJsonObject(const GeneratedAccountDto account, QString installationId)
{
    ...
    QString defaultNetworksContent = defaultNetworks.readAll().replace("%INFURA_KEY%", "220a1abb4b6943a093c35d0ce4fb0732");
...
QJsonObject Service::getDefaultNodeConfig(QString installationId)
{
    ...
    nodeConfigContent = nodeConfigContent.replace("%INFURA_KEY%", "220a1abb4b6943a093c35d0ce4fb0732");
    qDebug() << "config content: " << nodeConfigContent;
