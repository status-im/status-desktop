...
Item {
    ...
    Component {
        ...
        SwapSignModal {
            ...
            accountEmoji: "🚗"
            accountColorId: Constants.walletAccountColors.primary
    ...
    TestCase {
        ...
        function test_fromToProps() {
            ...
            controlUnderTest.fromTokenAmount = "1000.42"
            ...
            compare(controlUnderTest.subtitle, qsTr("1000.42 SNT to 1.42 ETH"))

            // info box
            const headerText = findChild(controlUnderTest.contentItem, "headerText")
            verify(!!headerText)
            compare(headerText.text, qsTr("Swap 1000.42 SNT to 1.42 ETH in %1 on %2").arg(controlUnderTest.accountName).arg(controlUnderTest.networkName))
        ...
        function test_accountInfo() {
            ...
            compare(accountBox.asset.color, Utils.getColorForId(controlUnderTest.accountColorId))
        }
