...
GridLayout {
    ...
    GridLayout {
        ...
        StatusListPicker {
            id: languagePicker
            z: 100
            inputList: ModelsData.languagePickerModel
        ...
        StatusListPicker {
            id: languagePicker2
            z: 100
            inputList: ModelsData.languageNoImagePickerModel
            placeholderSearchText: qsTr("Search Languages")
        ...
        StatusListPicker {
            id: currencyPicker
            inputList: ModelsData.currencyPickerModel
        ...
        StatusListPicker {
            id: currencyPicker2
            inputList: ModelsData.currencyPickerModel2
            placeholderSearchText: qsTr("Search Currencies")
            multiSelection: true
            printSymbol: true
